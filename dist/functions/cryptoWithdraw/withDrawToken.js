...
const withDrawToken = async (props, token) => {
    ...
    try {
        const transaction = await tronWeb.transactionBuilder.sendToken(walletAddress, amountToSend, tokenId, fromAddress);
...
const withDrawUSDT = (props) => withDrawToken(props, "USDT");
const withDrawUSDC = (props) => withDrawToken(props, "USDC");
const withDrawTUSD = (props) => withDrawToken(props, "TUSD");
